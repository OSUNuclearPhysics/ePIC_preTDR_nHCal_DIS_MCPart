...
//	drawMCpartEtabin("data/ep_noradcor.18x275_q2_0_1_run001.0000.eicrecon.tree_full.root", 1.0, "outputSpectra/eta", "outputEnePos_eta.root", "h_MCpart_pos_eta");
	...
	drawMCpartEtabin("data/output_primary_full.root", -1.0, "outputSpectra/eta_primary", "outputEneNeg_eta.root", "h_MCpart_neg_eta");
	drawMCpartEtabin("data/output_primary_full.root", 1.0, "outputSpectra/eta_primary", "outputEnePos_eta.root", "h_MCpart_pos_eta");
